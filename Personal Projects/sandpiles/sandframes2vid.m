function [abox,adefault]=sandframes2vid(frames,edgeCondition,filename,framerate)
...
adefault=imresize(average,[1080 1080]);
abox=imresize(average,[1080 1080],'box');
...
frames=imresize(frames,[1080 1080],'box');
